...
class BCAddressField(models.CharField):
    error_messages = {
        'invalid': 'Invalid Bitcoin address.',
    }

    def __init__(self, *args, **kwargs):
        super(BCAddressField, self).__init__(max_length=35, *args, **kwargs)
    ...
    def validate(self, value, model_instance):
        ...
        return super(BCAddressField, self).validate(value, model_instance)

    def deconstruct(self):
        name, path, args, kwargs = super(BCAddressField, self).deconstruct()
        del kwargs["max_length"]
        return name, path, args, kwargs


class BitcoinAmountField(models.DecimalField):
    max_digits = 16
    decimal_places = 8
    default = Decimal(0),
